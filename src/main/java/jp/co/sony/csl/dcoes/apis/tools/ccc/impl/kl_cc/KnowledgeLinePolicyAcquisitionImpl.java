...
/**
 * KnowledgeLine から POLICY を取得する実装.
 * {@link PolicyAcquisition} で使用される.
 * @author OES Project
 */
public class KnowledgeLinePolicyAcquisitionImpl implements PolicyAcquisition.Impl {
	private static final Logger log = LoggerFactory.getLogger(KnowledgeLinePolicyAcquisitionImpl.class);
	 ...
	 */
	public KnowledgeLinePolicyAcquisitionImpl(Vertx vertx) {
		vertx_ = vertx;
